...
def submit():
 ...
 return Response(r,mimetype="image/gif",headers={"Content-disposition": "attachment; filename=myplot.gif"})
""" response = requests.get(url)
 ...
 return (jsonify(result=blob))
 blob.upload_from_string(photo.read(),content_type=Image.open(urllib.request.urlopen(url)))
