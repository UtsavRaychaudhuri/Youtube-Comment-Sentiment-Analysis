...
def submit():
    '''
    Handles word from the form and passes the word to get_gif_from_api
    and downloads the GIF into local machine
    '''
...
def upload_photo():
     '''
     passes the photo to face_recognition
     renders gif_view with joy, anger and suprise likelihood
     '''
...
def server_error(e):
    app.logger.info('An error occurred during a request.')
